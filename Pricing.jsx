        ...
        <div className="box-1">
         ...
         <div className="box-2bg">
            ...
            <div className="box-2">
                ...
                <div className="left_div">
                    <div className="headDiv">
                        <div className="headContent">
                            <h3>Basic</h3>
                            <p>Get started quickly with our core features.</p>

                          </div>
                            <div className="price">                          
                            <span className="dollar">$</span>
                            <span className="targetNum">9</span>
                    ...
                    <div className="signUp">
                        <button  className="btn-left2">
                            <a href="https://www.campaignmonitor.com/signup/?sv=mobile-pricing-USD">Sign up</a>
                        </button>
                    </div>       
                  <div className="feature-box">
                    <ul>
                        <li className="bold">Send up to 2,500 emails</li>
                        <li className="bold">Customer support via email</li>
                        <li>All core email marketing features</li>
                        <li>Insights analytics suite</li>
                        <li>Marketing automation to your list</li>
                     </ul>
                  </div>
                </div>
                </div>  
                ...
                <div className="mclassName_div">
                    <div className="headDiv">
                        <div className="headContent">
                            <h3>Unlimited</h3>
                            <p>Unlimited emails for the frequent sender.</p>

                        </div>
                        <div className="price">
                         
                            <span className="dollar">$</span>
                            <span className="targetNum">29</span>
                  ...
                  <div className="feature-box">
                    <ul>
                        <li className="bold">Unlimited emails to your list</li>
                        <li className="bold">All core email marketing features</li>
                        <li>Insights analytics suite</li>
                        <li>Unlimited marketing automation to your list</li>
                        <li>Unlimited inbox previews</li>
                        <li>Time zone sending</li>
                        <li>Unlimited spam testing</li>
                ...
                <div className="right_div">
                    <div className="headDiv">
                        <div className="headContent">
                            <h3>Premier</h3>
                            <p>Advanced segmentation plus premium support.</p>

                        </div>
                        <div className="price">                        
                            <span className="dollar">$</span>
                            <span className="targetNum">149</span>
                            <span className="month">
                                /month
                            </span>                   
                    </div>
                    ...
                    <div className="feature-box">
                     <ul>
                        <li className="bold">Unlimited emails to your list</li>
                        <li className="bold">Premier phone and email support</li>
                        <li>All core email marketing features</li>
                        <li>Insights analytics suite</li>
                        <li>Unlimited marketing automation to your list</li>
                        <li>Unlimited spam testing</li>
                        <li>Countdown timer</li>
                        <li>Pre-built engagement segments</li>
                        <li>Send-time optimization</li>
                        <li>Advanced link tracking</li>
                        <li>Email builder section locking</li>
